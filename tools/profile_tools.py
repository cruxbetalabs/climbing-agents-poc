...
@registry.register(schema={
    ...
    "function": {
        ...
        "description": (
            ...
            "training focus, and other personal attributes. Always call this first "
            "when the user asks about their profile or when you need context about who they are."
        ),
        "parameters": {
            "type": "object",
            "properties": {},
...
@registry.register(schema={
    ...
    "function": {
        ...
        "parameters": {
            "type": "object",
            "properties": {
                "key":   {"type": "string", "description": "Profile field name, e.g. 'peak_boulder_grade'"},
